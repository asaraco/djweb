  ...
  ngOnInit(): void {
    ...
    */
    ...
    this.playlistDataService.retrieveAutomixQueue().subscribe(data => {
      ...
      //setInterval(() => this.ngOnInit(), remainingTimeMs + 1000);  // add 1000 ms delay to give VDJ time to update queue
      // Set current track progress bar interval
