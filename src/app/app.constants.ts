...
export const API_URL = "http://music.legendarylan.com:80";
export const LISTEN_URL = "http://dj.legendarylan.com:8000/legendarydj";
...
export const UI_UPLOAD_SUCCESS_TEXT = "Your file should appear in the New Arrivals section in a few moments. If it doesn't, try the manual refresh button.";
...
export const UI_WELCOME_TEXT     = "<strong>Welcome to Legendary Radio!</strong><br> " 
                                 ...
                                 + "If you still can't find what you need, type something and click 'Ask the DJ' to submit a manual request and the DJ will see what they can find. (There is an additional library of songs/remixes/edits that aren't searchable.) You can also access this via http://virtualdj.com/ask/Legendary__LAN<br>";
...
export const UI_HELPTEXT_UPLOAD  = "<strong>Uploads / Streaming</strong><br>"
                                 ...
                                 + "The search bar will also bring up songs available to stream from Deezer. Search results are limited to 100, but just add more search terms if you need to narrow it down. Songs tagged 'explicit' by Deezer will require a manual review before play (AKA they probably won't be).<br>"
                                 + "Online songs which have already been added to the database (by the DJ or upon request) are indicated by a different font color. Request them while you can, because you never know when they might disappear due to boycotts or greedy record labels!"
                                 + "<strong>please avoid adding songs that contain explicit or otherwise upsetting content.</strong> We realize this can be subjective, but please make an effort to consider the sensibilities of everyone in the room. We strive to maintain a welcome and fun environment for everyone, including a variety of backgrounds and beliefs (and ages). We will quietly delete any songs that don't align with this goal.";
